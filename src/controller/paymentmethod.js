            ...
            case 'add':
                admin.popup({
                    ...
                    , success: function (layero, index) {
                        view(this.id).render('teachingaffairservice/paymentmethod/add').done(function () {
                            form.render();
                            //监听提交
    ...
    table.on('tool(paymentmethod-table)', function (obj) {
        ...
        if (obj.event === 'del') {
            ...
            admin.popup({
                ...
                , resize: false
                , success: function (layero, index) {
                    view(this.id).render('teachingaffairservice/paymentmethod/edit', data).done(function () {
                        form.render();
