    ...
    exports('setter', {
        ...
        , apiAddress: {
            ...
            awinemodule: {
                ...
                listwithchedkedstatusforsaasversion: 'http://localhost:8001/api/modules/listwithchedkedstatusforsaasversion',
            ...
            saasversion: {
                list: 'http://localhost:8001/api/saasversion/list',
                pagelist: 'http://localhost:8001/api/saasversion/pagelist',
                add: 'http://localhost:8001/api/saasversion/add',
                delete: 'http://localhost:8001/api/saasversion/delete',
                update: 'http://localhost:8001/api/saasversion/update',
            },
            saaspricingtactics: {
                list: 'http://localhost:8001/api/saaspricingtactics/list',
                pagelist: 'http://localhost:8001/api/saaspricingtactics/pagelist',
                add: 'http://localhost:8001/api/saaspricingtactics/add',
            ...
            tenantsettings: {
                ...
                update: 'http://localhost:8001/api/tenantsettings/update',
            },
            marketingchannel: {
